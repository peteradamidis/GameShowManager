              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #8B0000; border-radius: 8px; margin: 0 0 20px 0;">
                <tr>
                  <td style="padding: 25px; text-align: center;">
                    ...
                    <a href="mailto:${bookingReplyToEmail}?subject=${encodeURIComponent(`BOOKING RESPONSE - ${contestant.name} - ${recordDate}`)}&body=${`Hi%20Deal%20or%20No%20Deal%20Team,%0D%0A%0D%0AName:%20${encodeURIComponent(contestant.name)}%0D%0ADate:%20${encodeURIComponent(recordDate)}%0D%0A%0D%0ACAN%20YOU%20ATTEND%3F%20YES%20/%20NO%0D%0A%0D%0AGroup%20members%20attending%20(full%20names):%0D%0A1.%0D%0A2.%0D%0A3.%0D%0A%0D%0AMedical%20conditions:%0D%0A%0D%0AMobility%20requirements:%0D%0A%0D%0AEmergency%20contact%20(name%20%26%20phone):%0D%0A%0D%0ADietary:%20Vegetarian%20/%20Vegan%20/%20Gluten%20Free%20/%20Dairy%20Free%0D%0A%0D%0AThank%20you!`}" style="display: inline-block; padding: 18px 50px; background: linear-gradient(135deg, #D4AF37 0%, #b8962e 100%); color: #2a0a0a; text-decoration: none; font-size: 18px; font-weight: bold; text-transform: uppercase; letter-spacing: 2px; border-radius: 8px; box-shadow: 0 4px 12px rgba(212,175,55,0.4);">CLICK HERE TO REPLY</a>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #8B0000; border-radius: 8px; margin: 0 0 20px 0;">
                <tr>
                  <td style="padding: 25px; text-align: center;">
                    ...
                    <a href="mailto:${standbyReplyToEmail}?subject=${encodeURIComponent(`STANDBY RESPONSE - ${standby.contestant.name} - ${formattedDate}`)}&body=${`Hi%20Deal%20or%20No%20Deal%20Team,%0D%0A%0D%0AName:%20${encodeURIComponent(standby.contestant.name)}%0D%0ADate:%20${encodeURIComponent(formattedDate)}%0D%0A%0D%0ACAN%20YOU%20ATTEND%20AS%20STANDBY%3F%20YES%20/%20NO%0D%0A%0D%0AGroup%20members%20attending%20(full%20names):%0D%0A1.%0D%0A2.%0D%0A3.%0D%0A%0D%0AMedical%20conditions:%0D%0A%0D%0AMobility%20requirements:%0D%0A%0D%0AEmergency%20contact%20(name%20%26%20phone):%0D%0A%0D%0ADietary:%20Vegetarian%20/%20Vegan%20/%20Gluten%20Free%20/%20Dairy%20Free%0D%0A%0D%0AThank%20you!`}" style="display: inline-block; padding: 18px 50px; background: linear-gradient(135deg, #D4AF37 0%, #b8962e 100%); color: #2a0a0a; text-decoration: none; font-size: 18px; font-weight: bold; text-transform: uppercase; letter-spacing: 2px; border-radius: 8px; box-shadow: 0 4px 12px rgba(212,175,55,0.4);">CLICK HERE TO REPLY</a>
                  </td>
                </tr>
              </table>
...
<body style="margin: 0; padding: 0; font-family: Arial, Helvetica, sans-serif; background-color: #2a0a0a;">
  ...
  app.get("/api/email-preview/booking", async (req, res) => {
    ...
    try {
      ...
      const replyMailto = `mailto:${replyToEmail}?subject=${encodeURIComponent(`BOOKING RESPONSE - ${sampleName} - ${sampleDate}`)}&body=${`Hi%20Deal%20or%20No%20Deal%20Team,%0D%0A%0D%0AName:%20${encodeURIComponent(sampleName)}%0D%0ADate:%20${encodeURIComponent(sampleDate)}%0D%0A%0D%0ACAN%20YOU%20ATTEND%3F%20YES%20/%20NO%0D%0A%0D%0AGroup%20members%20attending%20(full%20names):%0D%0A1.%0D%0A2.%0D%0A3.%0D%0A%0D%0AMedical%20conditions:%0D%0A%0D%0AMobility%20requirements:%0D%0A%0D%0AEmergency%20contact%20(name%20%26%20phone):%0D%0A%0D%0ADietary:%20Vegetarian%20/%20Vegan%20/%20Gluten%20Free%20/%20Dairy%20Free%0D%0A%0D%0AThank%20you!`}`;
...
<body style="margin: 0; padding: 20px; font-family: Arial, Helvetica, sans-serif; background-color: #f5f5f5;">
  ...
  app.get("/api/email-preview/standby", async (req, res) => {
    ...
    try {
      ...
      // Build mailto link
      const replyMailto = `mailto:${replyToEmail}?subject=${encodeURIComponent(`STANDBY RESPONSE - ${sampleName} - ${sampleDate}`)}&body=${`Hi%20Deal%20or%20No%20Deal%20Team,%0D%0A%0D%0AName:%20${encodeURIComponent(sampleName)}%0D%0ADate:%20${encodeURIComponent(sampleDate)}%0D%0A%0D%0ACAN%20YOU%20ATTEND%20AS%20STANDBY%3F%20YES%20/%20NO%0D%0A%0D%0AGroup%20members%20attending%20(full%20names):%0D%0A1.%0D%0A2.%0D%0A3.%0D%0A%0D%0AMedical%20conditions:%0D%0A%0D%0AMobility%20requirements:%0D%0A%0D%0AEmergency%20contact%20(name%20%26%20phone):%0D%0A%0D%0ADietary:%20Vegetarian%20/%20Vegan%20/%20Gluten%20Free%20/%20Dairy%20Free%0D%0A%0D%0AThank%20you!`}`;
