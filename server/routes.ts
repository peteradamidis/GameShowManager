              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #8B0000; border-radius: 8px; margin: 0 0 20px 0;">
                <tr>
                  <td style="padding: 25px; text-align: center;">
                    ...
                    <a href="mailto:${standbyReplyToEmail}?subject=${encodeURIComponent(`STANDBY RESPONSE - ${standby.contestant.name} - ${formattedDate}`)}&body=${encodeURIComponent(`Hi Deal or No Deal Team,\n\nRegarding my Deal or No Deal STANDBY booking:\n\nName: ${standby.contestant.name}\nDate: ${formattedDate}\n\nCAN YOU ATTEND? (mark with X)\n[ ] YES - I confirm my standby attendance\n[ ] NO - I cannot attend (Reason: )\n\nGroup members attending (please provide FULL NAMES):\n1. (Full Name):\n2. (Full Name):\n3. (Full Name):\n\n--- REQUIRED INFORMATION (if attending) ---\n\nDo you have any medical conditions?\nIf yes, please describe:\n\nDo you have any mobility requirements? (i.e. issues climbing stairs or standing for extended periods)\nAnswer:\n\nEmergency contact name & phone number:\nAnswer:\n\nDietary requirements (mark with X):\n[ ] Vegetarian\n[ ] Vegan\n[ ] Gluten Free\n[ ] Dairy Free\n\nPlease note that all our meals are nut-free. If your dietary requirements fall outside the options, we won't be able to cater to them, so we kindly ask that you bring your own meals.\n\nThank you!`)}" style="display: inline-block; padding: 18px 50px; background: linear-gradient(135deg, #D4AF37 0%, #b8962e 100%); color: #2a0a0a; text-decoration: none; font-size: 18px; font-weight: bold; text-transform: uppercase; letter-spacing: 2px; border-radius: 8px; box-shadow: 0 4px 12px rgba(212,175,55,0.4);">CLICK HERE TO REPLY</a>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #8B0000; border-radius: 8px; margin: 0 0 20px 0;">
                <tr>
                  <td style="padding: 25px; text-align: center;">
                    ...
                    <a href="mailto:${replyToEmail}?subject=${encodeURIComponent(`BOOKING RESPONSE - ${testContestantName} - ${testRecordDate}`)}&body=${encodeURIComponent(`Hi Deal or No Deal Team,\n\nRegarding my Deal or No Deal booking:\n\nName: ${testContestantName}\nDate: ${testRecordDate}\n\nCAN YOU ATTEND? (mark with X)\n[ ] YES - I confirm my attendance\n[ ] NO - I cannot attend (Reason: )\n\nGroup members attending (please provide FULL NAMES):\n1. (Full Name):\n2. (Full Name):\n3. (Full Name):\n\n--- REQUIRED INFORMATION (if attending) ---\n\nDo you have any medical conditions?\nIf yes, please describe:\n\nDo you have any mobility requirements? (i.e. issues climbing stairs or standing for extended periods)\nAnswer:\n\nEmergency contact name & phone number:\nAnswer:\n\nDietary requirements (mark with X):\n[ ] Vegetarian\n[ ] Vegan\n[ ] Gluten Free\n[ ] Dairy Free\n\nPlease note that all our meals are nut-free. If your dietary requirements fall outside the options, we won't be able to cater to them, so we kindly ask that you bring your own meals.\n\nThank you!`)}" style="display: inline-block; padding: 18px 50px; background: linear-gradient(135deg, #D4AF37 0%, #b8962e 100%); color: #2a0a0a; text-decoration: none; font-size: 18px; font-weight: bold; text-transform: uppercase; letter-spacing: 2px; border-radius: 8px; box-shadow: 0 4px 12px rgba(212,175,55,0.4);">CLICK HERE TO REPLY</a>
                  </td>
                </tr>
              </table>
...
<body style="margin: 0; padding: 0; font-family: Arial, Helvetica, sans-serif; background-color: #2a0a0a;">
  ...
  app.get("/api/email-preview/booking", async (req, res) => {
    ...
    try {
      ...
      const replyMailto = `mailto:${replyToEmail}?subject=${encodeURIComponent(`BOOKING RESPONSE - ${sampleName} - ${sampleDate}`)}&body=${encodeURIComponent(`Hi Deal or No Deal Team,\n\nRegarding my Deal or No Deal booking:\n\nName: ${sampleName}\nDate: ${sampleDate}\n\nCAN YOU ATTEND? (mark with X)\n[ ] YES - I confirm my attendance\n[ ] NO - I cannot attend (Reason: )\n\nGroup members attending (please provide FULL NAMES):\n1. (Full Name):\n2. (Full Name):\n3. (Full Name):\n\n--- REQUIRED INFORMATION (if attending) ---\n\nDo you have any medical conditions?\nIf yes, please describe:\n\nDo you have any mobility requirements? (i.e. issues climbing stairs or standing for extended periods)\nAnswer:\n\nEmergency contact name & phone number:\nAnswer:\n\nDietary requirements (mark with X):\n[ ] Vegetarian\n[ ] Vegan\n[ ] Gluten Free\n[ ] Dairy Free\n\nPlease note that all our meals are nut-free. If your dietary requirements fall outside the options, we won't be able to cater to them, so we kindly ask that you bring your own meals.\n\nThank you!`)}`;
