              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #8B0000; border-radius: 8px; margin: 0 0 20px 0;">
                <tr>
                  <td style="padding: 25px; text-align: center;">
                    ...
                    <a href="mailto:${bookingReplyToEmail}?subject=${encodeURIComponent(`BOOKING RESPONSE - ${contestant.name} - ${recordDate}`)}&body=${`Hi Deal or No Deal Team,%0D%0A%0D%0AName: ${encodeURIComponent(contestant.name)}%0D%0ADate: ${encodeURIComponent(recordDate)}%0D%0A%0D%0ACAN YOU ATTEND? YES / NO%0D%0A%0D%0AGroup members attending (full names):%0D%0A1.%0D%0A2.%0D%0A3.%0D%0A%0D%0AMedical conditions:%0D%0A%0D%0AMobility requirements:%0D%0A%0D%0AEmergency contact (name %26 phone):%0D%0A%0D%0ADietary: Vegetarian / Vegan / Gluten Free / Dairy Free%0D%0A%0D%0AThank you!`}" style="display: inline-block; padding: 18px 50px; background: linear-gradient(135deg, #D4AF37 0%, #b8962e 100%); color: #2a0a0a; text-decoration: none; font-size: 18px; font-weight: bold; text-transform: uppercase; letter-spacing: 2px; border-radius: 8px; box-shadow: 0 4px 12px rgba(212,175,55,0.4);">CLICK HERE TO REPLY</a>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #8B0000; border-radius: 8px; margin: 0 0 20px 0;">
                <tr>
                  <td style="padding: 25px; text-align: center;">
                    ...
                    <a href="mailto:${standbyReplyToEmail}?subject=${encodeURIComponent(`STANDBY RESPONSE - ${standby.contestant.name} - ${formattedDate}`)}&body=${`Hi Deal or No Deal Team,%0D%0A%0D%0AName: ${encodeURIComponent(standby.contestant.name)}%0D%0ADate: ${encodeURIComponent(formattedDate)}%0D%0A%0D%0ACAN YOU ATTEND AS STANDBY? YES / NO%0D%0A%0D%0AGroup members attending (full names):%0D%0A1.%0D%0A2.%0D%0A3.%0D%0A%0D%0AMedical conditions:%0D%0A%0D%0AMobility requirements:%0D%0A%0D%0AEmergency contact (name %26 phone):%0D%0A%0D%0ADietary: Vegetarian / Vegan / Gluten Free / Dairy Free%0D%0A%0D%0AThank you!`}" style="display: inline-block; padding: 18px 50px; background: linear-gradient(135deg, #D4AF37 0%, #b8962e 100%); color: #2a0a0a; text-decoration: none; font-size: 18px; font-weight: bold; text-transform: uppercase; letter-spacing: 2px; border-radius: 8px; box-shadow: 0 4px 12px rgba(212,175,55,0.4);">CLICK HERE TO REPLY</a>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #8B0000; border-radius: 8px; margin: 0 0 20px 0;">
                <tr>
                  <td style="padding: 25px; text-align: center;">
                    ...
                    <a href="mailto:${replyToEmail}?subject=${encodeURIComponent(`BOOKING RESPONSE - ${testContestantName} - ${testRecordDate}`)}&body=${`Hi Deal or No Deal Team,%0D%0A%0D%0AName: ${encodeURIComponent(testContestantName)}%0D%0ADate: ${encodeURIComponent(testRecordDate)}%0D%0A%0D%0ACAN YOU ATTEND? YES / NO%0D%0A%0D%0AGroup members attending (full names):%0D%0A1.%0D%0A2.%0D%0A3.%0D%0A%0D%0AMedical conditions:%0D%0A%0D%0AMobility requirements:%0D%0A%0D%0AEmergency contact (name %26 phone):%0D%0A%0D%0ADietary: Vegetarian / Vegan / Gluten Free / Dairy Free%0D%0A%0D%0AThank you!`}" style="display: inline-block; padding: 18px 50px; background: linear-gradient(135deg, #D4AF37 0%, #b8962e 100%); color: #2a0a0a; text-decoration: none; font-size: 18px; font-weight: bold; text-transform: uppercase; letter-spacing: 2px; border-radius: 8px; box-shadow: 0 4px 12px rgba(212,175,55,0.4);">CLICK HERE TO REPLY</a>
                  </td>
                </tr>
              </table>
...
<body style="margin: 0; padding: 0; font-family: Arial, Helvetica, sans-serif; background-color: #2a0a0a;">
  ...
  app.get("/api/email-preview/booking", async (req, res) => {
    ...
    try {
      ...
      const replyMailto = `mailto:${replyToEmail}?subject=${encodeURIComponent(`BOOKING RESPONSE - ${sampleName} - ${sampleDate}`)}&body=${`Hi Deal or No Deal Team,%0D%0A%0D%0AName: ${encodeURIComponent(sampleName)}%0D%0ADate: ${encodeURIComponent(sampleDate)}%0D%0A%0D%0ACAN YOU ATTEND? YES / NO%0D%0A%0D%0AGroup members attending (full names):%0D%0A1.%0D%0A2.%0D%0A3.%0D%0A%0D%0AMedical conditions:%0D%0A%0D%0AMobility requirements:%0D%0A%0D%0AEmergency contact (name %26 phone):%0D%0A%0D%0ADietary: Vegetarian / Vegan / Gluten Free / Dairy Free%0D%0A%0D%0AThank you!`}`;
...
<body style="margin: 0; padding: 20px; font-family: Arial, Helvetica, sans-serif; background-color: #f5f5f5;">
  ...
  app.get("/api/email-preview/standby", async (req, res) => {
    ...
    try {
      ...
      // Build mailto link
      const replyMailto = `mailto:${replyToEmail}?subject=${encodeURIComponent(`STANDBY RESPONSE - ${sampleName} - ${sampleDate}`)}&body=${`Hi Deal or No Deal Team,%0D%0A%0D%0AName: ${encodeURIComponent(sampleName)}%0D%0ADate: ${encodeURIComponent(sampleDate)}%0D%0A%0D%0ACAN YOU ATTEND AS STANDBY? YES / NO%0D%0A%0D%0AGroup members attending (full names):%0D%0A1.%0D%0A2.%0D%0A3.%0D%0A%0D%0AMedical conditions:%0D%0A%0D%0AMobility requirements:%0D%0A%0D%0AEmergency contact (name %26 phone):%0D%0A%0D%0ADietary: Vegetarian / Vegan / Gluten Free / Dairy Free%0D%0A%0D%0AThank you!`}`;
